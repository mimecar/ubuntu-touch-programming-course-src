...
UBUNTU_TRANSLATION_DOMAIN="calculator.mimecar"
...
aptest.commands = bash $$PWD/Calculator/tests/autopilot/run
aptest.depends  = sub-Calculator

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Calculator/tests/unit 
unittest.depends  = sub-Calculator
