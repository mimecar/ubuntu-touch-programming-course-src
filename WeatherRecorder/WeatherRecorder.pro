...
UBUNTU_TRANSLATION_DOMAIN="weatherrecorder.fulvio"
...
aptest.commands = bash $$PWD/WeatherRecorder/tests/autopilot/run
aptest.depends  = sub-WeatherRecorder

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/WeatherRecorder/tests/unit
unittest.depends  = sub-WeatherRecorder
