...
UBUNTU_TRANSLATION_DOMAIN="weatherrecorderchart.username"
...
aptest.commands = bash $$PWD/WeatherRecorderChart/tests/autopilot/run
aptest.depends  = sub-WeatherRecorderChart

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/WeatherRecorderChart/tests/unit 
unittest.depends  = sub-WeatherRecorderChart
