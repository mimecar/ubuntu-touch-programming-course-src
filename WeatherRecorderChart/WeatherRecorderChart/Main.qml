...
/*!
  MainView of the WeatherRecorderChart App
*/
...
MainView {    
    ...
    property string appLicationTitle : i18n.tr("WeatherRecorderChart");
    ...
    PageStack {
        ...
        Page {
            ...
            Column{
                    ...
                    Component {
                        ...
                        Popover {
                            ...
                            DatePicker {
                                ...
                                Component.onDestruction: {
                                    /* before inserting the value is added the current year from config param table */
                ...
                /* ----------------(NEW) ANALYTIC SECTION (i.e Chart) -------------- */

                Row{
                    id: chartSectionHeader
                    anchors.horizontalCenter: parent.horizontalCenter
                    Text {
                        id: chartSectionHeaderText
                        text: i18n.tr("Analytic section")
                        font.bold: true
                        color: UbuntuColors.graphite
                        font.pointSize: units.gu(1.5)
                    }
